...
CREATE TABLE IF NOT EXISTS legal_sections (
  ...
  paragraphs  JSONB       NOT NULL DEFAULT '[]',    -- array de strings (parágrafos)
...
-- Seed com o conteúdo atual hardcoded em frontend/src/Pages/Legal.jsx
...
) AS seed(tag, paragraphs, sort_order, is_active)
