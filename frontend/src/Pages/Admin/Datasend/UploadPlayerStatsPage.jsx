...
export default function UploadPlayerStatsPage() {
  ...
  async function handleImport() {
    ...
    try {
      await api.post("/xlsx/import-player-stats", formData, {
        headers: { "Content-Type": "multipart/form-data" }
      });
  ...
  return (
    <BaseUploadLayout
      title="Importação de Estatísticas de Jogadores"
      subtitle="Suba a planilha com dados individuais por temporada."
      {...{
        file,
        setFile,
        step,
