...
function ClubChip({ club, onRemove, draggable, onDragStart }) {
  return (
    ...
    >
      ...
      {club.crest_url
        ? <img src={clubLogo(club.crest_url, club.slug)} onError={handleCrestRetry} className="w-4 h-4 object-contain shrink-0" alt="" />
          ...
          {filtered.map(club => (
            <div key={club.id_club}
              ...
              <div className="flex items-center gap-2 min-w-0">
                {club.crest_url
                  ? <img src={clubLogo(club.crest_url, club.slug)} onError={handleCrestRetry} className="w-5 h-5 object-contain shrink-0" alt="" />
            ...
            <div className="flex flex-col gap-1 mt-1.5 max-h-40 overflow-y-auto">
              {seasonClubs.map(c => (
                <div key={c.id_club} className="flex items-center gap-1.5 text-xs text-gray-600 py-0.5">
                  {c.crest_url
                    ? <img src={clubLogo(c.crest_url, c.slug)} onError={handleCrestRetry} className="w-3.5 h-3.5 object-contain shrink-0" alt="" />
