...
export default function UserDetailPage() {
    ...
    // Forms
    const [form, setForm] = useState({ name: "", email: "", role: "", plan_id: "" });
    ...
    return (
        <div className="w-full max-w-7xl mx-auto p-4 sm:p-8 animate-in fade-in duration-500 relative">
            ...
            {showConfirmModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-in fade-in">
                    <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" onClick={() => !processingAction && setShowConfirmModal(null)}/>
