// components/revenue/RevenueTableChart.jsx (LEAGUE)
...
export default function RevenueTableChart({
  ...
  }, [data, mainLeagueId, ligasSelecionadas, leagueColor, leagueMap]);
      ...
      <table className="w-full text-sm">
        ...
        <tbody>
          {adapted.series.map((serie) => (
            <tr
              key={serie.name}
              className="border-b last:border-0 sticky left-0 bg-white py-2 pl-4"
            >
              <td className="py-2 pl-4">
                <span className="flex gap-2 items-center">
                  <div
                    ...
                    style={{
                      backgroundColor: leagueColor[serie.id]?.color_one
                    }}
                  />
                  {serie.name}
                </span>
