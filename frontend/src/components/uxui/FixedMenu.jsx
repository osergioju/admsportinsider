...
export default function FixedMenu({ mode : mode }) {
  return (
    <div>
        ...
        {
            mode ? (
                <div className="fixed bottom-2 w-full left-0 z-40 lg:hidden">
                        ...
                        <div className="gap-2 flex items-center justify-between flex-wrap">
                            ...
                            <div className="text-center">
                                <button className="cursor-pointer transition-all group hover:bg-[#7F33D9] hover:border-[#7F33D9] border border-[#AFAFB2] rounded-full w-[50px] h-[50px] flex flex-col items-center justify-center">
                                    <Heart strokeWidth={1} className="text-[#7F33D9] group-hover:text-white transition-all w-[30px]"></Heart>
                                </button>
                            </div> 
                            <div className="text-center">
                                <button className="cursor-pointer transition-all group hover:bg-[#7F33D9] hover:border-[#7F33D9] border border-[#AFAFB2] rounded-full w-[50px] h-[50px] flex flex-col items-center justify-center">
                                    <Search strokeWidth={1} className="text-[#7F33D9] group-hover:text-white transition-all w-[30px]"></Search>
                                </button>
                            </div>
                            <div className="text-center">
                                <button className="cursor-pointer transition-all group hover:bg-[#7F33D9] hover:border-[#7F33D9] border border-[#AFAFB2] rounded-full w-[50px] h-[50px] flex flex-col items-center justify-center">
