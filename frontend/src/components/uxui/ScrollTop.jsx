...
const STATIC_TITLES = {
  ...
  "/dashboard/leagues": "Competições",
  "/dashboard/leagues/favorites": "Competições favoritas",
  ...
  "/admin/gestao-ligas": "Gestão de Competições",
  "/admin/hospitalidade": "Hospitalidade",
  "/admin/gestao-clubes": "Gestão de Clubes",
  "/admin/gestao-clubes/escudos": "Escudos em massa",
  ...
  "/admin/insights/ligas": "Insights · Competições",
