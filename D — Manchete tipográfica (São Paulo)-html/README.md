# D — Manchete tipográfica (São Paulo) — design reference
...
- `Opcao-D.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `Opcao-D.dc.html`;
