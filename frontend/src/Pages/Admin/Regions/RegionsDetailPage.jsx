...
import { ArrowLeft, Languages, Activity, Code2, Map } from "lucide-react";
...
export default function RegionDetailPage() {
  ...
  if (loading) {
    return (
      <div className="w-full max-w-5xl mx-auto p-6 flex flex-col gap-6 animate-pulse">
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4 sm:p-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Info Card - Coluna Principal */}
        <div className="md:col-span-2 space-y-6">
            <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-sm">
                <h2 className="text-lg font-bold text-gray-900 mb-6">Informações Gerais</h2>
                ...
                <div className="grid grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div>
                            {region.active ? (
                                <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold bg-green-50 text-green-700 border border-green-200">
                                Ativa
                                </span>
                            ) : (
        ...
        <div className="space-y-4">
            ...
            <Link
                ...
                className="group flex flex-col bg-white border border-gray-200 rounded-2xl p-5 shadow-sm hover:shadow-md hover:border-purple-300 transition-all cursor-pointer"
            >
                <div className="w-10 h-10 rounded-full bg-purple-50 flex items-center justify-center text-[#7F33D9] mb-3 group-hover:scale-110 transition-transform">
                    <Languages size={20} />
                </div>
            ...
            <Link
                to={`/admin/regions/${region.id}/financial-indicators`} // Mantive o link igual ao seu original, ajuste se necessário
                className="group flex flex-col bg-white border border-gray-200 rounded-2xl p-5 shadow-sm hover:shadow-md hover:border-purple-300 transition-all cursor-pointer"
            >
