        ...
        <div className="p-6 space-y-6 overflow-y-auto custom-scrollbar">
          ...
          <div className="border-t border-gray-100 pt-6">
            ...
            <div className="flex gap-3 mb-4">
                <SelectionCard type="draft" icon={FileText} label="Rascunho" colorClass="border-gray-300 text-gray-600"/>
                <SelectionCard type="now" icon={Send} label="Imediato" colorClass="border-green-500 text-green-600"/>
                <SelectionCard type="scheduled" icon={Calendar} label="Agendar" colorClass="border-blue-500 text-blue-600"/>
            </div>
            {sendType === 'scheduled' && (
