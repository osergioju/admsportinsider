...
import LogoWatermark from "../../img/footer-logo.png";
import ContainerLogo from "../../img/container-logo.png";
import ContainerBallLogo from "../../img/container-ball-logo.png";
import LogoHome from "../../img/sportinsider-logo.png"
...
export default function Login() {
    ...
    return (
        <div className="w-full h-screen overflow-y-auto overflow-x-hidden bg-[linear-gradient(180deg,#0C0718_0%,#3F257E_100%)] text-white">
            <div className="flex flex-col min-h-screen">
                        ...
                        <div className="flex flex-wrap items-center justify-center space-y-8 lg:space-y-0">
                            ...
                            <div className="w-full lg:w-1/2 h-[400px] lg:h-[80svh] relative flex items-center justify-center">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
                                    <img 
                                        src={ContainerBallLogo} 
                                        alt="Background Decoration" 
                                        className="w-[55%] max-w-none h-auto opacity-60 object-contain scale-125" 
                                    />
                                </div>
                            ...
                            <div className="w-full lg:w-1/2 px-4 lg:px-8">
                                <div className="w-full lg:max-w-[500px] lg:mx-auto">
                                    ...
                                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="text-right">
                                                <Link
                                                    to="/reset-password"
                                                    className="text-sm text-[#D8B5FF] hover:text-white transition-colors"
                                                >
                                                    Esqueceu sua senha?
                                                </Link>
                                            </div>
                                        ...
                                        <div className="mt-2">
                                            <button
                                                type="submit"
                                                className="w-full h-12 rounded-full bg-[linear-gradient(109.09deg,#FFFFFF_3.35%,#E7D3FF_96.65%)] hover:opacity-90 transition-all flex items-center justify-center gap-2 group"
                                            >
                                                <span className="text-[#7F33D9] cursor-pointer font-medium text-base">Entrar</span>
                                                <svg 
                                    ...
                                    <button
                                        ...
                                        className="w-full h-12 bg-transparent border border-[#FFFFFF33] hover:bg-[#FFFFFF0D] text-white rounded-full flex items-center justify-center gap-3 transition-all"
                                    >
                                        ...
                                        <span className="font-medium cursor-pointer text-sm text-[#FFFFFF99]">Entrar com o Google</span>
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <footer className="w-full relative overflow-hidden pt-20 pb-8 mt-auto z-10">
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[120%] h-[500px] bg-[radial-gradient(50%_50%_at_50%_50%,#7E34D9_0%,rgba(126,52,217,0)_100%)] opacity-20 pointer-events-none blur-[120px] z-0"></div>
                    <div className="container mx-auto px-6 relative z-10">
                        
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex justify-center opacity-50 pointer-events-none select-none">
                            <img 
                                src={LogoWatermark} 
