...
router.get("/leagues/:id/indicators/annual", optionalAuth, getLeagueAnnualIndicators);
...
router.get("/leagues/:id/prizes", optionalAuth, getLeaguePrizes);
