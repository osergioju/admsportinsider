    ...
    <div className="w-full bg-[#030015]">
        ...
        <div className="py-20 bg-[#F5F0F0] w-full relative overflow-hidden">
            ...
            <div className="container items-center mx-auto px-6 relative z-10">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center gap-0 relative mb-20">
                    {/* (Conteúdo do Diagrama - Esquerda) */}
                ...
                {/* 2. GRID DE CARDS (Os 3 principais) */}
                <div className="grid lg:grid-cols-3 gap-6">
                    ...
                    {/* === CARD 3: COMPARATIVOS INTELIGENTES (COM SWIPER) === */}
                    <div className={cardClass}>
                        <div className="mb-6">
                ...
                <div className="w-full mt-6 bg-[#FFF5F5] border border-pink-50 rounded-[32px] relative overflow-hidden group shadow-sm flex flex-col justify-center h-[408px]">
                    ...
                    <div className="relative w-full overflow-hidden mask-linear-fade">
                        ...
                        <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#FFF5F5] to-transparent z-10 pointer-events-none"></div>
                        <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#FFF5F5] to-transparent z-10 pointer-events-none"></div>
                        ...
                        <div className="flex animate-marquee items-center">
                            ...
                            <img 
                                ...
                                className="h-32 lg:h-40 w-auto max-w-none opacity-80 grayscale hover:grayscale-0 transition-all duration-500" 
                            />
                            ...
                            <img 
                                src={SlideImage} 
                                alt="Cobertura Global de Ligas" 
                                className="h-32 lg:h-40 w-auto max-w-none opacity-80 grayscale hover:grayscale-0 transition-all duration-500 hidden 2xl:block" 
                            />
                        </div>
                    </div>
                </div> 
            ...
            <div className="container mx-auto px-10">
                <div className="text-left flex flex-col items-start mb-4">
                    ...
                    <div className="mb-6 flex items-center gap-2 px-4 py-1.5 bg-white border border-[#E5E7EB] rounded-full shadow-sm pointer-events-none select-none">
                        ...
                        <span className="text-[#8033D9] text-sm font-medium">Por dentro</span>
                    </div>
                ...
                <div className="bg-black w-full relative rounded-2xl overflow-hidden group">
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-6 lg:p-12 justify-between text-left z-10 text-white flex items-end">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="w-full flex flex-col items-center text-center">
                    ...
                    <div className="mb-8 flex items-center gap-2 px-4 py-1.5 bg-[#ffffff0a] border border-[#ffffff15] rounded-full backdrop-blur-md pointer-events-none select-none">
                        ...
                        <span className="text-[#D4BBFC] text-sm font-medium">Por dentro</span>
                    </div>
