                ...
                <ul className="space-y-1">
                    ...
                    <div className="group">
                        <MenuItem 
                            ...
                            icon={<BarChart2 strokeWidth={1.5} size={20} className={iconStyle}/>} 
                            label={<span className={textStyle}>Comparativo</span>} 
                        />
                    </div>
                    ...
                    { user ? ( 
                        <div className="group">
                            <MenuItem 
                                to="/meu-dashboard" 
                                className={menuItemStyle}
                                icon={<Heart strokeWidth={1.5} size={20} className={iconStyle}/>} 
                                label={<span className={textStyle}>Meu Dashboard</span>} 
                            />
                        </div>
                    ) : ( null ) }
                    ...
                    <div className="group">
                        <MenuItem 
                            ...
                            to="/relatorios" 
                            className={menuItemStyle}
                            icon={<FileText strokeWidth={1.5} size={20} className={iconStyle}/>} 
                            label={<span className={textStyle}>Relatórios</span>} 
                        />
                    </div>
                </ul>
            </div>
